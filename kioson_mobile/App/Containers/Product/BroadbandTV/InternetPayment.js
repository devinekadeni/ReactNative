...
import { ScrollView, Text, View, AsyncStorage, Keyboard, TouchableOpacity, PermissionsAndroid, ToastAndroid } from 'react-native'
...
class InternetPayment extends Component {
  ...
  render () {
    const { keyboardShow, errorMessage, editable, phoneNumber, idCustomer, serviceProductChoose, modalLodaing, presetInternet } = this.state
