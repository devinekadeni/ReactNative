...
import { ScrollView, Text, View, TouchableOpacity, Keyboard, PermissionsAndroid, AsyncStorage, ToastAndroid } from 'react-native'
...
class CableTvPayment extends Component {
  ...
  render () {
    const { keyboardShow, presetNominalTv, serviceProductName, serviceProductId, errorMessage, editable, phoneNumber, idCustomer, serviceProductChoose, modalLodaing, presetTv } = this.state
