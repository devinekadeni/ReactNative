...
class TransferSaldo extends Component {
      ...
      if (err) {
        ...
        if (contact.phoneNumbers) {
          ...
          if (listContact.length > 1) {
            ...
            this.setState({ destinationNumber: listContact[0], alert: {...this.state.alert, transferAmount: ''} })
  ...
  render () {
    ...
    const {alert, destinationNumber, transferAmount, errMessage, modalLoading, keyboardShow} = this.state
