...
import { ScrollView, Text, StatusBar, AsyncStorage, PermissionsAndroid, View, TouchableOpacity, ToastAndroid, Keyboard } from 'react-native'
...
class PDAMPayment extends Component {
  ...
  render () {
    ...
    const {keyboardShow, errorMessage, editable, phoneNumber, idCustomer, areaChoose} = this.state
