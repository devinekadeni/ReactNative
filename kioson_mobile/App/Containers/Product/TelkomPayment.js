...
import { ScrollView, StatusBar, View, PermissionsAndroid, ToastAndroid, AsyncStorage, Keyboard } from 'react-native'
...
class TelkomPayment extends Component {
  ...
  render () {
    ...
    const { keyboardShow, message, customerPhoneNumber, phoneNumber } = this.state
