...
import { ScrollView, Text, FlatList, StatusBar, View, AsyncStorage, Keyboard } from 'react-native'
...
class PaymentConfirmation extends Component {
  ...
  render () {
    const { orderMobile, orderMobileData, orderPostpaid, orderPhone, orderPdam, orderMoneyProps } = this.props
    const {serviceType, keyboardShow, dataDetail, titleForm, discountAmount, dataConfirmation, discount} = this.state
