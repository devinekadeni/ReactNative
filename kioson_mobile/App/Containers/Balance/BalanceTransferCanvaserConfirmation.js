...
class BalanceTransferCanvaserConfirmation extends Component {
  ...
  renderData (label, data) {
    return (
      <View style={{ flexDirection: 'row', marginBottom: moderateScale(5), marginTop: moderateScale(5) }}>
        <Text style={[styles.amountBalance, { flex: 1 }]}>
          {label}
        </Text>
  ...
  renderTotal (label, data) {
    return (
      <View style={{ flexDirection: 'row' }}>
        <Text style={[styles.amountBalance, { flex: 1, color: Colors.nice_blue, fontFamily: Fonts.type.robotoBold }]}>
          {label}
        </Text>
        <Text style={[styles.amountBalance, { color: Colors.nice_blue, fontFamily: Fonts.type.robotoBold }]}>
          {data}
        </Text>
      </View>
    )
  ...
  renderLabel () {
    return (
      <Text style={[styles.amountBalance, { margin: moderateScale(15), marginTop: moderateScale(5), marginBottom: moderateScale(5) }]}>
