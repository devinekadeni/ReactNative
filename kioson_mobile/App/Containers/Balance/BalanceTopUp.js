...
class BalanceTopUp extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      isVerified: true, // false => kyc is not complete, true if kyc is complete
      amountTransaction: 320000,
      amount: '',
      data: [
        {
          'id': 1,
  ...
  renderHeader () {
    const { balance, amountTransaction } = this.state
      ...
      <View style={styles.boxContainer}>
        <View style={styles.box}>
          <View style={{ flexDirection: 'column', flex: 1, marginTop: moderateScale(10) }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: ratioWidth(10), marginTop: ratioHeight(-5) }}>
      ...
      return (
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => this.topUp()}
          >
            <Text style={[styles.textButton, { color: Colors.snow, fontSize: moderateScale(12) }]}>
