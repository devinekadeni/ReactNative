...
class BalanceTransferBankThankPage extends Component {
  ...
  renderDate () {
    ...
    if (activePayment === 6) {
      ...
      const time = moment(dateRequest).format('DD MMM YYYY - h:mm').toString()
      return (
        <View style={styles.dateContainer}>
          <Text style={styles.date}>
  ...
  renderAmount () {
    ...
    const styleLastDigit = activePayment === 1 || activePayment === 6 ? styles.transferBold : styles.transfer
    return (
      <View style={{ flexDirection: 'row' }}>
      ...
      return (
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity style={styles.paymentContainer} onPress={() => this.openTutorial()}>
            ...
            <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate}] }]} />
          </TouchableOpacity>
        </View>
      )
    } else if (activePayment === 3) {
        ...
        <View style={{ flexDirection: 'column', borderColor: Colors.black_15, borderWidth: moderateScale(1) }}>
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(1)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate1}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(1)}
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(2)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate2}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(2)}
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(3)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate3}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(3)}
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(4)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate4}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(4)}
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(5)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate5}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(5)}
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity style={styles.paymentContainerNoBorder} onPress={() => this.openVa(6)}>
              ...
              <Image source={Images.ic_arrow_grey_up} style={[styles.arrow, { transform: [{rotate: rotate6}] }]} />
            </TouchableOpacity>
          </View>
          {this.renderVa(6)}
        </View>
      ...
      if (openVa === active && openVa === 1) {
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui ATM Bank BRI :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Mobile Banking :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>VA melalui Internet Banking BRI :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Teller Bank BRI :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Mini ATM BRI :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui ATM lain :</Text>
  ...
  renderVaSinarmas (active) {
    ...
    if (activePayment === 4) {
      if (openVaSinarmas === active && openVaSinarmas === 1) {
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui ATM Bank Sinarmas :</Text>
            <Text style={styles.textTypeAccount}>1. Masukkan kartu ATM dan PIN Bank BCA Anda.</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Simobi :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>VA melalui Internet Banking Sinarmas :</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Teller Sinarmas :</Text>
            <Text style={styles.textTypeAccount}>1. Ambil nomor antrian transaksi Teller dan isi slip setoran.</Text>
        ...
        return (
          <View style={styles.tutorialContainerNoBorder}>
            <Text style={[styles.textTypeAccount, { fontFamily: Fonts.type.robotoBold }]}>Lakukan pembayaran melalui Mini ATM Sinarmas :</Text>
            <Text style={styles.textTypeAccount}>1. Pilih menu Mini ATM.</Text>
            <Text style={styles.textTypeAccount}>2. Pilih menu Pembayaran.</Text>
  ...
  renderResi () {
    ...
    return (
      <View style={styles.resiContainer}>
        ...
        <Text style={[styles.labelPayment, { fontSize: moderateScale(12), marginTop: ratioHeight(4) }]}>
          {time} WIB
        </Text>
      </View>
    )
