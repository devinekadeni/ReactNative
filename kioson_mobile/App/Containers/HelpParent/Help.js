...
class Help extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      helpMenu:
      [
        {id: 0, title: 'Akun', icon: Images.ic_account_color, onPress: () => navigate('SearchPage', {data: dataAccount, emptyState: false})},
        {id: 1, title: 'Saldo', icon: Images.ic_balance_color, onPress: () => navigate('SearchPage', {data: dataSaldo, emptyState: false})},
        {id: 2, title: 'Promo', icon: Images.ic_promotion_color, onPress: () => navigate('SearchPage', {data: dataPromo, emptyState: false})},
        {id: 3, title: 'Penyalahgunaan', icon: Images.ic_report_color, onPress: () => navigate('SearchPage', {data: dataPenyalahgunaan, emptyState: false})},
        {id: 4, title: 'Fitur', icon: Images.ic_feature_color, onPress: () => navigate('SearchPage', {data: dataFitur, emptyState: false})},
        {id: 5, title: 'Lainnya', icon: Images.ic_3dot_color, onPress: () => navigate('HelpForm', {topic: 'Lainnya'})}
      ]
    }
  }
