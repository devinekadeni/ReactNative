...
import { ScrollView, StatusBar, View, TextInput, Text, Keyboard, Easing, TouchableOpacity, Image } from 'react-native'
...
class HelpForm extends Component {
  ...
  render () {
    const { isError, keyboardShow, topic, description, phoneNumber, image, fileSize, showLength, maxLine, height } = this.state
    if (image) {
