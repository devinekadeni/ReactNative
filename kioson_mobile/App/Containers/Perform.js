...
class Perform extends Component {
      ...
      return (
        <View style={[styles.modalSort, {top: this.layout.yPosition + moderateScale(0)}]}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            style={[styles.listSort, {borderBottomColor: Colors.black_35, borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'center'}]}>
            <Text style={[styles.robotoRegularsmallBlue, {color: Colors.slate_grey}]}>Transaksi Terbesar</Text>
            <Image
              style={this.state.modalSort ? [styles.imgDropdown, {transform: [{rotate: '180deg'}]}] : [styles.imgDropdown, {transform: [{rotate: '90deg'}]}]}
              source={Images.ic_dropdown_small}
              resizeMode={'stretch'} />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => this.onPressSort('Transaksi Terkecil')}
            activeOpacity={0.8} style={styles.listSort}>
            <Text style={[styles.robotoRegularsmallBlue, {color: Colors.slate_grey}]}>Transaksi Terkecil</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => this.onPressSort('Transaksi Terbanyak')}
            activeOpacity={0.8} style={styles.listSort}>
            <Text style={[styles.robotoRegularsmallBlue, {color: Colors.slate_grey}]}>Transaksi Terbanyak</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => this.onPressSort('Transaksi Tersedikit')}
            activeOpacity={0.8} style={styles.listSort}>
            <Text style={[styles.robotoRegularsmallBlue, {color: Colors.slate_grey}]}>Transaksi Tersedikit</Text>
          </TouchableOpacity>
        </View>
      )
    }
  ...
  changeDate (value) {
    ...
    console.tron.warn(startMasking)
    console.tron.warn(endMasking)
