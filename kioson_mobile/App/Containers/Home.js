...
class Home extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      data:
      [
        {title: 'Pulsa &\nPaket Data', icon: Images.ic_pulsa, onPress: () => this.props.dataLogin.login ? navigate('MenuTopUpBalance') : navigate('SignIn')},
  ...
  renderSaldo () {
    ...
    return (
      <View style={styles.viewSaldoNew}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image style={{ width: ratioWidth(32), height: ratioHeight(32) }} source={Images.ic_isi_saldo} resizeMode={'stretch'} />
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('BalanceTopUp')}>
            <View style={styles.btnIsiSaldo}>
              <Image style={{ width: ratioWidth(10), height: ratioWidth(10) }} source={Images.ic_plus} resizeMode={'stretch'} />
