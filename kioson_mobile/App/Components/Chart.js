      ...
      <ScrollView
        ...
        <VictoryChart
          ...
          <VictoryArea
            ...
            labelComponent={<VictoryLabel dx={-1} dy={20} renderInPortal verticalAnchor='middle' textAnchor='middle' />}
            animate={{
              duration: 2000,
            ...
            style={{
              ...
              labels: {fill: Colors.slate_grey, fontSize: 7, fontFamily: Fonts.type.robotoRegular}
            }}
            standalone={false}
            />
          <VictoryAxis
